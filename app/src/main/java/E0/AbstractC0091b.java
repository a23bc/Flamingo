...
public abstract class AbstractC0091b {
    ...
    public static final void a(C0092c c0092c, H h) {
        ...
        for (int i7 = 0; i7 < size; i7++) {
            ...
            if (j3 instanceof M) {
                ...
                H h7 = (H) j3;
                c0092c2.f1706k = h7.f1657o;
                c0092c2.c();
                c0092c2.l = h7.f1658p;
                c0092c2.f1713s = true;
                c0092c2.c();
                c0092c2.f1709o = h7.f1661s;
                c0092c2.f1713s = true;
                c0092c2.c();
                c0092c2.f1710p = h7.f1662t;
                c0092c2.f1713s = true;
                c0092c2.c();
                c0092c2.f1711q = h7.f1663u;
                c0092c2.f1713s = true;
                c0092c2.c();
                c0092c2.f1712r = h7.f1664v;
                c0092c2.f1713s = true;
                c0092c2.c();
                c0092c2.f1707m = h7.f1659q;
                c0092c2.f1713s = true;
                c0092c2.c();
                c0092c2.f1708n = h7.f1660r;
                c0092c2.f1713s = true;
                c0092c2.c();
                c0092c2.f1702f = h7.f1665w;
                c0092c2.f1703g = true;
                c0092c2.c();
                a(c0092c2, h7);
                c0092c.e(i7, c0092c2);
    ...
    public static final void b(C1976i c1976i, double d4, double d7, double d8, double d9, double d10, double d11, double d12, boolean z6, boolean z7) {
        double d13;
        double d14;
        double d15 = d10;
        ...
        double d17 = ((d7 * dSin) + (d4 * dCos)) / d15;
        double d18 = ((d7 * dCos) + ((-d4) * dSin)) / d11;
        ...
        if (d27 < 0.0d) {
            ...
            b(c1976i, d4, d7, d8, d9, d15 * dSqrt, d11 * dSqrt, d12, z6, z7);
            return;
        }
        ...
        while (i7 < iCeil) {
            ...
            c1976i.a((float) ((d45 * dSqrt3) + d46), (float) ((d47 * dSqrt3) + d48), (float) (d50 - (dSqrt3 * d52)), (float) (d51 - (dSqrt3 * d53)), (float) d50, (float) d51);
            d46 = d50;
            i7 = i8 + 1;
            d32 = d32;
            dSin2 = dSin2;
    ...
    public static final L c(C0095f c0095f, C0912t c0912t) {
        n1.d dVar = (n1.d) c0912t.j(AbstractC0403q0.h);
        boolean zE = c0912t.e((((long) Float.floatToRawIntBits(dVar.b())) & 4294967295L) | (((long) Float.floatToRawIntBits(c0095f.f1742j)) << 32));
        Object objK = c0912t.K();
        if (zE || objK == C0903o.f11850a) {
            C0092c c0092c = new C0092c();
            a(c0092c, c0095f.f1739f);
            long jFloatToRawIntBits = (((long) Float.floatToRawIntBits(dVar.v(c0095f.f1735b))) << 32) | (((long) Float.floatToRawIntBits(dVar.v(c0095f.f1736c))) & 4294967295L);
            float fIntBitsToFloat = c0095f.f1737d;
            if (Float.isNaN(fIntBitsToFloat)) {
                fIntBitsToFloat = Float.intBitsToFloat((int) (jFloatToRawIntBits >> 32));
            }
            float fIntBitsToFloat2 = c0095f.f1738e;
            ...
            L l = new L(c0092c);
            long j3 = c0095f.f1740g;
            C1980m c1980m = j3 != 16 ? new C1980m(j3, c0095f.h) : null;
            l.f1670s.setValue(new C1895e(jFloatToRawIntBits));
            l.f1671t.setValue(Boolean.valueOf(c0095f.f1741i));
            F f7 = l.f1672u;
            f7.f1650g.setValue(c1980m);
            f7.f1651i.setValue(new C1895e(jFloatToRawIntBits2));
            f7.f1646c = c0095f.f1734a;
            c0912t.i0(l);
            objK = l;
        }
        return (L) objK;
    ...
    public static final void d(List list, C1976i c1976i) {
        Path path;
        int i7;
        float f7;
        int i8;
        ...
        float f15;
        List list2 = list;
        C1976i c1976i2 = c1976i;
        Path.FillType fillType = c1976i2.f20241a.getFillType();
        Path.FillType fillType2 = Path.FillType.EVEN_ODD;
        boolean z6 = fillType == fillType2;
        Path path2 = c1976i2.f20241a;
        path2.rewind();
        if (!z6) {
            fillType2 = Path.FillType.WINDING;
        }
        path2.setFillType(fillType2);
        C c8 = list2.isEmpty() ? C0100k.f1770c : (C) list2.get(0);
        int size = list2.size();
        float f16 = 0.0f;
        int i9 = 0;
        float f17 = 0.0f;
        ...
        while (i9 < size) {
            ...
            if (c9 instanceof C0100k) {
                ...
                if (c9 instanceof w) {
                    w wVar = (w) c9;
                    float f23 = wVar.f1805c;
                    f17 += f23;
                    float f24 = wVar.f1806d;
                    f18 += f24;
                    path2.rMoveTo(f23, f24);
                    f21 = f17;
                    f22 = f18;
                } else if (c9 instanceof o) {
                    o oVar = (o) c9;
                    f17 = oVar.f1779c;
                    float f25 = oVar.f1780d;
                    path2.moveTo(f17, f25);
                    f18 = f25;
                    f22 = f18;
                    f21 = f17;
                } else if (c9 instanceof v) {
                    v vVar = (v) c9;
                    float f26 = vVar.f1803c;
                    float f27 = vVar.f1804d;
                    ...
                    if (c9 instanceof n) {
                        n nVar = (n) c9;
                        float f28 = nVar.f1777c;
                        f18 = nVar.f1778d;
                        c1976i2.c(f28, f18);
                        f15 = nVar.f1777c;
                    } else if (c9 instanceof u) {
                        u uVar = (u) c9;
                        path2.rLineTo(uVar.f1802c, f16);
                        f17 += uVar.f1802c;
                    } else if (c9 instanceof C0102m) {
                        C0102m c0102m = (C0102m) c9;
                        c1976i2.c(c0102m.f1776c, f18);
                        f15 = c0102m.f1776c;
                    } else if (c9 instanceof A) {
                        A a4 = (A) c9;
                        path2.rLineTo(f16, a4.f1638c);
                        f18 += a4.f1638c;
                    } else if (c9 instanceof B) {
                        B b7 = (B) c9;
                        c1976i2.c(f17, b7.f1639c);
                        f18 = b7.f1639c;
                    } else {
                        if (c9 instanceof t) {
                            t tVar = (t) c9;
                            path2.rCubicTo(tVar.f1797c, tVar.f1798d, tVar.f1799e, tVar.f1800f, tVar.f1801g, tVar.h);
                            Path path3 = path2;
                            float f29 = tVar.f1799e + f17;
                            f20 = tVar.f1800f + f18;
                            f17 += tVar.f1801g;
                            f18 += tVar.h;
                            c7 = c9;
                            ...
                            Path path4 = path2;
                            if (c9 instanceof C0101l) {
                                C0101l c0101l = (C0101l) c9;
                                c1976i2.a(c0101l.f1771c, c0101l.f1772d, c0101l.f1773e, c0101l.f1774f, c0101l.f1775g, c0101l.h);
                                f10 = c0101l.f1773e;
                                f11 = c0101l.f1774f;
                                f17 = c0101l.f1775g;
                                f18 = c0101l.h;
                                ...
                                if (c9 instanceof y) {
                                    ...
                                    y yVar = (y) c9;
                                    path4.rCubicTo(f14, f13, yVar.f1811c, yVar.f1812d, yVar.f1813e, yVar.f1814f);
                                    float f30 = yVar.f1811c + f17;
                                    float f31 = yVar.f1812d + f18;
                                    f17 += yVar.f1813e;
                                    f18 += yVar.f1814f;
                                    c7 = c9;
                                    f20 = f31;
                                    ...
                                    q qVar = (q) c9;
                                    c1976i.a(f17, f18, qVar.f1785c, qVar.f1786d, qVar.f1787e, qVar.f1788f);
                                    f10 = qVar.f1785c;
                                    f11 = qVar.f1786d;
                                    f17 = qVar.f1787e;
                                    f18 = qVar.f1788f;
                                    ...
                                    if (c9 instanceof x) {
                                        x xVar = (x) c9;
                                        float f33 = xVar.f1807c;
                                        float f34 = xVar.f1808d;
                                        float f35 = xVar.f1809e;
                                        float f36 = xVar.f1810f;
                                        path4.rQuadTo(f33, f34, f35, f36);
                                        f12 = xVar.f1807c + f17;
                                        float f37 = f34 + f18;
                                        f17 += f35;
                                        f18 += f36;
                                        ...
                                        p pVar = (p) c9;
                                        float f38 = pVar.f1781c;
                                        float f39 = pVar.f1782d;
                                        float f40 = pVar.f1783e;
                                        float f41 = pVar.f1784f;
                                        path4.quadTo(f38, f39, f40, f41);
                                        f12 = pVar.f1781c;
                                        f20 = f39;
                                        f17 = f40;
                                        f18 = f41;
                                        ...
                                        z zVar = (z) c9;
                                        float f42 = zVar.f1815c;
                                        float f43 = zVar.f1816d;
                                        path4.rQuadTo(f8, f9, f42, f43);
                                        f10 = f8 + f17;
                                        f11 = f9 + f18;
                                        f17 += zVar.f1815c;
                                        f18 += f43;
                                        ...
                                        r rVar = (r) c9;
                                        float f45 = rVar.f1789c;
                                        float f46 = rVar.f1790d;
                                        path4.quadTo(f17, f18, f45, f46);
                                        f20 = f18;
                                        f18 = f46;
                                        path = path4;
                                        c7 = c9;
                                        ...
                                        f19 = f17;
                                        f17 = rVar.f1789c;
                                    } else if (c9 instanceof s) {
                                        s sVar = (s) c9;
                                        float f47 = sVar.h + f17;
                                        float f48 = sVar.f1796i + f18;
                                        i8 = i9;
                                        path = path4;
                                        f7 = 0.0f;
                                        i7 = size;
                                        b(c1976i, f17, f18, f47, f48, sVar.f1791c, sVar.f1792d, sVar.f1793e, sVar.f1794f, sVar.f1795g);
                                        f17 = f47;
                                        f19 = f17;
                                        f18 = f48;
                                        f20 = f18;
                                        ...
                                        f7 = f16;
                                        i8 = i9;
                                        if (!(c9 instanceof C0099j)) {
                                            throw new W();
                                        }
                                        C0099j c0099j = (C0099j) c9;
                                        double d4 = c0099j.h;
                                        float f49 = c0099j.f1769i;
                                        c7 = c9;
                                        b(c1976i, f17, f18, d4, f49, c0099j.f1764c, c0099j.f1765d, c0099j.f1766e, c0099j.f1767f, c0099j.f1768g);
                                        f17 = c0099j.h;
                                        f19 = f17;
                                        f18 = f49;
                                    }
