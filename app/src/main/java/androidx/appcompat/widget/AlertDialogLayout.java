...
public class AlertDialogLayout extends AbstractC1343v0 {
    ...
    */
    ...
    public final void onMeasure(int i7, int i8) {
        ...
        if (view2 != null) {
            int i12 = paddingBottom - i9;
            int iMin = Math.min(i11, measuredHeight);
            if (iMin > 0) {
                i11 -= iMin;
                i9 += iMin;
            }
            view2.measure(i7, View.MeasureSpec.makeMeasureSpec(i9, 1073741824));
            paddingBottom = i12 + view2.getMeasuredHeight();
            iCombineMeasuredStates = View.combineMeasuredStates(iCombineMeasuredStates, view2.getMeasuredState());
        }
        if (view3 != null && i11 > 0) {
            view3.measure(i7, View.MeasureSpec.makeMeasureSpec(measuredHeight2 + i11, mode));
        ...
        int i14 = i8;
        alertDialogLayout.setMeasuredDimension(View.resolveSizeAndState(alertDialogLayout.getPaddingRight() + alertDialogLayout.getPaddingLeft() + iMax, i7, iCombineMeasuredStates), View.resolveSizeAndState(paddingBottom, i14, 0));
        if (mode2 != 1073741824) {
            ...
            while (i15 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c1341u0).width == -1) {
                        int i16 = ((LinearLayout.LayoutParams) c1341u0).height;
                        ((LinearLayout.LayoutParams) c1341u0).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i14, 0);
                        ((LinearLayout.LayoutParams) c1341u0).height = i16;
                    }
                }
                i15++;
