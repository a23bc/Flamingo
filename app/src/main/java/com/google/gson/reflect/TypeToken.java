...
public class TypeToken<T> {
    ...
    public TypeToken() {
        ...
        this.rawType = d.g(typeTokenTypeArgument);
    ...
    private Type getTypeTokenTypeArgument() {
        ...
        if (genericSuperclass instanceof ParameterizedType) {
            ...
            if (parameterizedType.getRawType() == TypeToken.class) {
                return d.a(parameterizedType.getActualTypeArguments()[0]);
            }
    ...
    public final boolean equals(Object obj) {
        return (obj instanceof TypeToken) && d.d(this.type, ((TypeToken) obj).type);
    }
    ...
    public boolean isAssignableFrom(Type type) {
        ...
        if (type2 instanceof GenericArrayType) {
            return this.rawType.isAssignableFrom(d.g(type)) && isAssignableFrom(type, (GenericArrayType) this.type);
        }
