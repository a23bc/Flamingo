...
public final class r {
    ...
    */
    public r(boolean r6, java.lang.String r7, int r8, byte[] r9, int r10, int r11, byte[] r12) {
        /*
            r5 = this;
            r0 = 2
            r5.<init>()
        ...
        L70:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: h3.r.<init>(boolean, java.lang.String, int, byte[], int, int, byte[]):void");
    }
}
