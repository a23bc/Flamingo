...
public final class InterpolatorC1193a implements Interpolator {
    ...
    public InterpolatorC1193a(float[] fArr) {
        this.f14363a = fArr;
        this.f14364b = 1.0f / (fArr.length - 1);
    }
