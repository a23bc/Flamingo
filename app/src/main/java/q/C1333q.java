...
public final class C1333q extends CheckBox implements K1.p {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final C0913t0 f15368o;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public final J2.r f15369p;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public final W f15370q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public C1342v f15371r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1333q(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, R.attr.checkboxStyle);
        Q0.a(context);
        P0.a(this, getContext());
        C0913t0 c0913t0 = new C0913t0(this);
        this.f15368o = c0913t0;
        c0913t0.d(attributeSet, R.attr.checkboxStyle);
        J2.r rVar = new J2.r(this);
        this.f15369p = rVar;
        rVar.d(attributeSet, R.attr.checkboxStyle);
        W w7 = new W(this);
        this.f15370q = w7;
        w7.f(attributeSet, R.attr.checkboxStyle);
        getEmojiTextViewHelper().a(attributeSet, R.attr.checkboxStyle);
    }

    private C1342v getEmojiTextViewHelper() {
        if (this.f15371r == null) {
            this.f15371r = new C1342v(this);
        }
        return this.f15371r;
    }
